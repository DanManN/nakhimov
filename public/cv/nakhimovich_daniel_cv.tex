...
\resumeItemListStart
\resumeBullet{Designed an automated workflow in AWS for generating an "Accompanying PDF" within the Virtual Voice Studio.}
\resumeBullet{Implemented the PDF generation workflow using CDK and Java as well as automated unit tests and integration tests achieving 100\% code coverage.}
\resumeBullet{Refined a personal development workflow using Amazon Bedrock through Cline to quickly develop and test prototype features while ensuring production level quality.}
\resumeItemListEnd
